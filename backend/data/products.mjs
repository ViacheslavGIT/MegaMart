const products = [
  ...
  { name: 'Dell XPS 15', brand: 'Dell', category: 'Laptops', price: 1899, off: 15, img: "/assets/dell.jpg" },
  { name: 'HP Spectre x360', brand: 'HP', category: 'Laptops', price: 1699, off: 12, img: "/assets/hp.jpg" },
  {
  ...
  // Headphones
  { name: 'AirPods Pro 2', brand: 'Apple', category: 'Headphones', price: 249, off: 10, img: "/assets/pords.jpg" },
  {
  ...
  { name: 'JBL Tour One M2', brand: 'JBL', category: 'Headphones', price: 299, off: 8, img: "/assets/pords.jpg" },
  {
  ...
  { name: 'Garmin Fenix 7', brand: 'Garmin', category: 'Watches', price: 699, off: 12, img: "/assets/pords.jpg" },
  {
  ...
  { name: 'Fitbit Sense 2', brand: 'Fitbit', category: 'Watches', price: 299, off: 10, img: "/assets/pords.jpg" },
  {
